		...
		<p><b>Choose Your Room</b></p><hr>
				<form class="form1" action="index.php" method="post" onsubmit="return validateForm()">
					...
					<div class="row">
						...
						<div class="large-4 columns">
						<p ><span class="fontgrey">Rate : INR </span><span style="font-size:24px;">100</span><span class="fontgrey">/ night</span><br>
				...
				<form class="form1" id="formaction" action="" method="post" onsubmit="return validateForm()">
					...
					<div class="row">
						...
						<div class="large-4 columns">
						<p ><span class="fontgrey">Rate : INR </span><span style="font-size:24px;">180</span><span class="fontgrey">/ night</span><br>
						<span style="text-align:right;">6 room available</span>
						</p>
							<div class="row">
								<div class="large-6 columns">
