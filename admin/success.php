...
mysqli_query($connection,"UPDATE `unleashe_hotel`.`booking` SET `payment_status` = 'confirmed' WHERE `booking`.`booking_id` = ".$_SESSION['booking_id'].";");
}
...
<div class="row " >
	<div class="large-4 columns blackblur "  style="margin-top:100px; ">
		<p class="fontslabo " style="text-align:left; font-size:18px;"><br><h4>Application Accepted</h4><hr> Dear <?php echo $_SESSION['firstname'];?>, <br>Please check your email confirmation. Thank you on using our facility.</p>
		<br>
