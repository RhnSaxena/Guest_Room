...
if(mysql_num_rows($result) > 0)
	{
		...
		$total = $row['total_amount'];
			...
			$subject = "Booking Application Received";
			$message ="<html>";
			$message .="<body>\n";
			...
			$message .="										<h1>Your Application Received!</h1>\n";
			$message .="									</td>\n";
			$message .="								</tr>\n";
			$message .="								<tr>\n";
			$message .="									<td class=\"content-block\">\n";
			$message .="										<h2>Thanks for the booking.</h2>\n";
			$message .="									</td>\n";
			$message .="								</tr>\n";
			$message .="								<tr>\n";
			$message .="									<td class=\"content-block\">\n";
			...
			$message .="															<br>\n";
			$message .="															<b>1. Please pay in cash upon check in.</b><br>\n";
			$message .="															<br>\n";
			$message .="															\n";
			$message .="												</td>\n";
			$message .="											</tr>\n";
			...
			$message .="						<tr>\n";
			$message .="							<td><br>Questions? Email <a href=\"mailto:\">dsaoffice@iiitdmj.ac.in</a></td>\n";
			$message .="						</tr>\n";
			$message .="					</table>\n";
			$message .="				</div></div>\n";
			$message .="		</td>\n";
