...
<div class="row " >
	<div class="large-4 columns blackblur "  style="margin-top:100px; ">
		<p class="fontslabo " style="text-align:left; font-size:18px;"><br><h4>Application Accepted</h4><hr><br>Please check your email regarding confirmation. Thank you on using our facility.</p>
		<br>
