...
<meta name="reservation portal for iiitdmj" >
<meta name="iiitdmj" content="www.iiitdmj.ac.in">
<meta name="copyright" content="IIITDMJ">
...
<div class="row " >
	<div class="large-4 columns blackblur "  style="margin-top:100px; ">
		<p class="fontslabo " style="text-align:left; font-size:18px;"><br><h4>Booking Pending</h4><hr> Dear <?php echo $_SESSION['firstname'];?>, <br>Your booking status is pending.</p>
		<br>
