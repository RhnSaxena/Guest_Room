...
include './auth.php';
mysqli_query("INSERT INTO `HOSTEL`.`guest` 
...
");
$id = mysql_insert_id();
mysql_query("INSERT INTO `HOSTEL`.`booking` (`booking_id`, `room_id`, `totalroombook`, `guest_id`, `total_adult`, `total_children`, `checkin_date`, `checkout_date`, `special_requirement`, `payment_status`, `total_amount`, `deposit`, `booking_date`) 
...
$message .='<br>Guests :'  .$_SESSION['adults'];
$message .='<br>Student:' .$_SESSION['firstname']. ',' .$_SESSION['lastname'];
...
$message .='<br>Purpose/Special Requirements'.$_SESSION['special_requirement'];
$message .='</p>';
$message .='';
$message .='</body></html>';
